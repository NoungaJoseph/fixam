...
export default function ReviewsPage({ onNavigate }: { onNavigate: (page: Page) => void }) {
  ...
  return (
    <div className="reviews-page">
      {/* SECTION 1 - PAGE HERO */}
      <section className="reviews-section reviews-container">
        {/* SECTION: Hero */}
      ...
      <section className="reviews-section" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="reviews-container">
          ...
          <div className="hiw-grid">
            {content.howItWorks.cards.map((card, i) => {
              // Outline icons
              const icons = [
                <svg className="hiw-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} key={i}>
